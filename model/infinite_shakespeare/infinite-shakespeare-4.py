...
class FeedForward(nn.Module):
    ...
    def __init__(self, n_embd):
        ...
        self.net = nn.Sequential(
            nn.Linear(n_embd, n_embd), # run the token through a linear manipulation
...
class MiniGPTLanguageModel(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        tok_emb = self.token_embedding_table(idx) # (B,T,C) This embeds the tokens with their INDEX value
